...
////////////////////////////////////
$consulta= "select a.*, b.*, c.* from equipos_asig a, pacientes b, sis_empresa c, ordenes d where d.id=a.numero_orden_a and d.id='".$archivo."' and d.id_paciente=b.id_paciente and b.id_empresa=c.rips";
$result=  mysql_query($consulta);
while($fila=  mysql_fetch_array($result)){

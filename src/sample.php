           ...
           var view="week";          
            ...
            function cal_beforerequest(type)
            {
                ...
                switch(type)
                {
                    ...
                    case 3:  
                    case 4:    
                        t="La solicitud está siendo procesando ...";                                   
                        break;
                }
                $("#errorpannel").hide();
            ...
            function Edit(data)
            {
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
                    ...
                    OpenModelWindow(url,{ width: 600, height: 400, caption:"Gestionar el Calendario",onclose:function(){
...
<body>
    <div>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle">Sistema Integral ( Calendario de Actividades )</div>
            <div id="loadingpannel" class="ptogtitle loadicon" style="display: none;">Cargando Datos...</div>
             <div id="errorpannel" class="ptogtitle loaderror" style="display: none;">Click en el boton de Actualizar para ver Cambios</div>
            </div>          
            ...
            <div class="btnseparator"></div>
             <div id="showtodaybtn" class="fbutton">
                <div><span title='Click para regresar al dia de hoy ' class="showtoday">
                Hoy</span></div>
            </div>
              <div class="btnseparator"></div>

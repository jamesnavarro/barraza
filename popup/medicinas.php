...
<script src="../popup/medicinas/funciones.js"></script>
...
include "../modelo/conexion.php";
     ...
     $request2=mysql_query('SELECT * FROM medicamentos WHERE codigo_int="'.$_GET['codigo'].'"');
     while($row2=mysql_fetch_array($request2))
	{     
          
              $a = $row2["codigo_int"];
              $b = $row2["nombre_medicamento"];
...
<div class="datagrid" id="empleados">
    <?php        include '../popup/medicinas/mostrar_tabla.php';  ?>

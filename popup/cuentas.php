...
<script src="../popup/cuentas/funciones.js"></script>
<script language="javascript" type="text/javascript">
function pasar(){
   window.opener.pasar_cuenta(document.getElementById('cod').value,document.getElementById('in').value);
   window.close();
}
</script>
...
include "../modelo/conexion.php";
     ...
     $request2=mysql_query('SELECT * FROM cont_codigos_contables WHERE cod_cod_cont="'.$_GET['codigo'].'"');
...
<div class="datagrid" id="empleados">
    <?php        include '../popup/cuentas/mostrar_tabla.php';  ?>

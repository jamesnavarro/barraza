...
//$paciente= $_GET['imprimir'];
 ...
 $strConsulta3 = "select * from facturas where numero_factura='".$_GET['imprimir']."' and tipo='".$_GET['t']."'  and estado='".$_GET['estado']."' ";
 ...
 $strConsulta3 = "select * from facturas where numero_factura='".$_GET['imprimir']."'  and estado='".$_GET['estado']."'";
	...
	$this->SetFont('Arial','B',8);
        if($_GET['t']=='FAC'){
            ...
            $this->Cell(0,10,'Recibo de Venta No. '.$fila3['numero_factura'],10,0,'R');
             $copa = 'Contado';
             $fecha_v = date("Y-m-d");
        }
...
function Footer()
{
	...
	$fila = mysql_fetch_array($pacientess);
        ...
        $strConsulta2 = "select * from actividad a, pacientes b, sis_empresa c where a.relacionado='".$_GET['imprimir']."' and a.tipo_factura='".$_GET['t']."' and a.id_paciente=b.id_paciente and b.id_empresa=c.rips limit 1";
	...
	$historial = $con->conectar();
        ...
        $consultaoe= "select * from actividad where relacionado='".$_GET['imprimir']."' and tipo_factura='".$_GET['t']."' group by orden_servicio";

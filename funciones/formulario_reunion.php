...
<body>
                        ...
                        <fieldset style="width:90%; float:center; margin-right: 5%;"><font color="red">Aviso: (*)Indica un campo requerido</font>
            <form name="insertar" action="../modelo/insertar_reunion_1.php" method="post" enctype="multipart/form-data">
                 <input type="submit" name="enviar" value="Guardar" class="alt_btn" onclick="">
					                           <a href="../vistas/contacto.php?codigo=<?php echo ($idc); ?>"><input type="button" name="cancelar" value="Cancelar"></a>
                                                                 <a href="../vistas/formulario_reunion.php?reunion=<?php echo ($idc); ?>"><input type="button" name="Programar reunion" value="Formulario Complecto" onclick=""></a>
                                                                 <br><br>
                                                          <label>Asunto : <font color="red"> *</font></label>
                                                          <input type="text" name="asunto" style="width:350px;height:20px;"/><br><br>
                                                           <label>Lugar : <font color="red"> *</font></label>
                                                           <input type="text" name="lugar" style="width:350px;height:20px;"/><br><br>
                                                          ...
                                                          <input type="text" name="fechai" class="tcal" style="width:80px;height:20px;"/>
                                                               ...
                                                               </select> A <select name="hora2"  style="width:40px;height:20px;" size="2">
                                                                   <option value="00">00</option>
                                                                   <option value="01">01</option>
                                                                   <option value="02">02</option>
                                                                   <option value="03">03</option>
                                                           ...
                                                           <input type="checkbox" name="aviso" value="on" style="width:350px;height:20px;"></div><br><br>
                                                       
                                                           <div><label>Descripcion :</label>
                                                         <textarea name="descripcion" style="width:40%;" rows="6"></textarea></div> <img src="../imagenes/reunion.png" alt="" width="100" height="100"/>
                                                        ...
                                                        $nom_ec=$f['nombre_emp']; echo $nom_ec;}} ?>"/>
                                                           ...
                                                           <input type="text" name="contacto_t1" id="valor1" readonly style="width:130px;height:20px;" value="<?php echo $_SESSION['nombre']; ?>"/>
                                                                <input type="text" name="contacto_t" readonly id="valor2" style="width:2px;height:2px;" value="<?php echo $idc ?>"/>
                                                               </div><br><br>

...
<body>
                      ...
                      <font color="red">Aviso: (*)Indica un campo requerido</font>  <fieldset style="width:90%; float:center; margin-right: 5%;">
            <form name="insertar" action="../modelo/insertar_reunion_2.php" method="post" enctype="multipart/form-data">

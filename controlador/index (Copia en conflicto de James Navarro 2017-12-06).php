...
if(isset($_SESSION['k_username'])){
    ...
    if($_GET['id']=='recibo_de_caja')          {if($crear_alq=='Habilitado')        {include '../vistas/alquiler/recibos.php';}                     else{include '../vistas/denied.php';}}
    ...
    if($_GET['id']=='facturas_anulada')            {if($acceso_fac=='Habilitado')    {include '../vistas/facturacion/facturas_anulada.php';}           else{include '../vistas/denied.php';}}
    ...
    if($_GET['id']=='barrios')                  {if($acceso_ven=='Habilitado')       {include '../vistas/barrios/index.php';}        else{include '../vistas/denied.php';}}
    ...
    if($_GET['id']=='atenciones_act'){include '../vistas/aten_activo/index.php';}

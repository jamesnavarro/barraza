...
$n = $_POST["cant"];
  ...
  if ($_POST["tipo$x"]=='atencion') {
       ...
       $sql = "UPDATE `actividad` SET `cod_aten` = '".$ate."', `precio_total` = '".$precio."', `anexo` = '".$anexo."' WHERE orden_servicio = '".$os."'";
...
if ($_POST["tipo$x"]=='medicina') {
 $precio =$_POST["precio$x"];
       ...
       mysql_query($sql, $conexion);
        ...
        echo "location.href='../vistas/?id=facturacion_autorizacion&factura=".$_GET['factura']."'";
    echo "</script>";

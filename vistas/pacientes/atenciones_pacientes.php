    ...
    <section class="body">
        <div class="body-inner">
            <div class="span12 widget dark stacked">
                <header>
                    <h4 class="title"> Pacientes Atendido por Mes</h4>
                                       ...
                                       <div class="span4">
                                           ...
                                           <input type="submit" class="btn" name="Buscar" value="Buscar">
                                            <?php
                                                ...
                                                <button type="button" class="btn"><a href="../vistas/auditoria_excel_2.php?ano=<?php echo $_POST['ano'].'&mes='.$_POST['mes'] ?>">Exportar</a></button>
                                            <?php } ?>
                                        </div>
...
if($_POST['mes']=='12'){$mes = 'DICIEMBRE';}
  ...
  $table = $table.'<tr><td>'.$cont.'<font></a></td>'
    ...
    ?> 
                                                    <p><h4>Reporte de Atenciones de Pacientes por mes.<br><hr>!Seleccione el año y el mes para imprimir el reporte¡</h4></p>                                              
                                                    <?php
}

<script> 
    function generar(fact){
        window.open('../vistas/rango.php','Form','width=500, height= 200');
    }
    </script>
<aside id="sidebar">
                                ...
                                <ul id="navigation">
                                   ...
                                   <form class="" action="" method="post" id="" enctype="multipart/form-data">
                                    ...
                                    <?php if($acceso_aten == 'Habilitado'){ ?>
                                        ...
                                        <!-- START Submenu Menu -->
                                        <ul id="submenu1" class="<?php  if($_GET['id']=='ver_orden_interna' || $_GET['id']=='llenar_atencion' || $_GET['id']=='add_atenciones' || $_GET['id']=='add_orden' || $_GET['id']=='ordenes'|| $_GET['id']=='ordenes_all'){echo 'collapse in';}else{echo 'collapse';}  ?>">
                                    ...
                                    <li class="accordion-group ">
                                        ...
                                        <ul id="submenu47" class="<?php  if($_GET['id']=='aud_atenc' ||$_GET['id']=='auditoria' ||$_GET['id']=='aud_atenciones'){echo 'collapse in';}else{echo 'collapse';}  ?>">
                                             <li class=""><a href="../vistas/?id=atenciones_act"><span class="icon icone-angle-right"></span> Atenciones activas</a></li>
...
<?php } ?>
                                    ...
                                    <li class="accordion-group ">
                                        ...
                                        <ul id="submenu13" class="<?php  if($_GET['id']=='noticias' ||$_GET['id']=='modificaciones' ||$_GET['id']=='areas' ||$_GET['id']=='user' ||$_GET['id']=='list_user' ||$_GET['id']=='rol' ){echo 'collapse in';}else{echo 'collapse';}  ?>">
                                            ...
                                            <li class=""><a href="../vistas/?id=barrios"><span class="icon icone-angle-right"></span>Barrios</a></li>
                                        </ul> 
                                        <!--/ END Submenu Menu -->
                                    </li>

...
echo "</script>"; 
    ...
    include '../modelo/consultar_empresa.php';
?>
<!DOCTYPE html>
            ...
            <?php 
                ...
                <!-- START Bootstrap Navbar -->
                    ...
                    <!-- START Row -->
                        ...
                        echo '<h3>Empresa : '.$nombre_emp.'</h3>';
        $request=mysql_query("SELECT * FROM actividad where id_seleccionado=".$_GET['cod']." and relacionado='Empresas' and estado='Completada' ");

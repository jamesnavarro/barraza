...
$request=mysql_query('SELECT a.*, c.*, b.* FROM equipos_ventas a, ordenes b, pacientes c WHERE b.facturado="No Facturado" and c.id_paciente=b.id_paciente and b.id=a.numero_orden_a  and estado_a="Pedido" group by b.id   '.$limit);
}
     ...
     $look ='<td><a href="../vistas/?id=add_detalle_venta&cod='.$row["numero_orden_a"].'&codigo_pac='.$row["id_paciente"].'"><img src="../imagenes/ojo.png" alt="ver" height="20px" width="20px"></a></td>';
         ...
         mysql_query($sqlr);
           ...
           if($row["regimen"]=='1'){$r= "Contributivo";}
            ...
            $mes = $row["fecha_a"];
             $t = substr("$mes",0, -3);
             if($t == date("2019-01")){$m = 'Enero';}
             if($t == date("2019-02")){$m = 'Febrero';}
             if($t == date("2019-03")){$m = 'Marzo';}
             if($t == date("2019-04")){$m = 'Abril';}
             if($t == date("2019-05")){$m = 'Mayo';}
             if($t == date("2019-06")){$m = 'Junio';}
             if($t == date("2019-07")){$m = 'Julio';}
             if($t == date("2019-08")){$m = 'Agosto';}
             if($t == date("2019-09")){$m = 'Septiembre';}
             if($t == date("2019-10")){$m = 'Octubre';}
             if($t == date("2019-11")){$m = 'Noviembre';}
             if($t == date("2019-12")){$m = 'Diciembre';}
             if($t == date("2020-01")){$m = 'Enero';}
             if($t == date("2020-02")){$m = 'Febrero';}
             if($t == date("2020-03")){$m = 'Marzo';}
             if($t == date("2020-04")){$m = 'Abril';}
             if($t == date("2020-05")){$m = 'Mayo';}
             if($t == date("2020-06")){$m = 'Junio';}
             if($t == date("2020-07")){$m = 'Julio';}
             if($t == date("2020-08")){$m = 'Agosto';}
             if($t == date("2020-09")){$m = 'Septiembre';}
             if($t == date("2020-10")){$m = 'Octubre';}
             if($t == date("2020-11")){$m = 'Noviembre';}
             if($t == date("2020-12")){$m = 'Diciembre';}
              if($t == date("2021-01")){$m = 'Enero';}
             if($t == date("2021-02")){$m = 'Febrero';}
             if($t == date("2021-03")){$m = 'Marzo';}
             if($t == date("2021-04")){$m = 'Abril';}
             if($t == date("2021-05")){$m = 'Mayo';}
             if($t == date("2021-06")){$m = 'Junio';}
             if($t == date("2021-07")){$m = 'Julio';}
             if($t == date("2021-08")){$m = 'Agosto';}
             if($t == date("2021-09")){$m = 'Septiembre';}
             if($t == date("2021-10")){$m = 'Octubre';}
             if($t == date("2021-11")){$m = 'Noviembre';}
             if($t == date("2021-12")){$m = 'Diciembre';}
...
$sql1 = "SELECT MAX(numero_factura) as id_inc FROM facturas where estado='' ";
...
$cambio = valorEnLetras($total); 
    ...
    $alquiler= 'ventas';
   	$sql = "INSERT INTO `facturas`(`tipo`,`copagos`,`cod_alquiler`, `fechai`, `fechaf`,`letras`,`numero_factura`, `id_paciente`, `orden_int`, `orden_ext`, `forma_pago`, `meses`, `pago_pendiente`, `fecha_ven`, `total`, `informacion`, `fecha_registro`)";

        $sql.= "VALUES ('FAC','".$copagos."','".$alquiler."','".$fi."', '".$fv."','".$cambio."','".$factura."', '".$paciente."', '".$orden_int."', '".$orden_ext."', '".$forma_pago."', '".$meses."', '".$pago_pendiente."', '".$fecha_venc."', '".$total."', '".$info."', '".$fecha_reg."')";
	mysql_query($sql);
...
$cambio = valorEnLetras($total); 
    ...
    echo 'La Orden No. :'.$_POST["valor2$x"].' ha sido Facturada, El No. de Recibo es :'.$factura.'<br>';

...
$req1=("SELECT *, max(a.cant_ins) as c, count(a.cant_ins) as t FROM actividad a, atenciones b WHERE a.estado='Completada' and a.cod_aten=b.codigo_atencion AND a.relacionado='".$f."' GROUP BY a.orden_servicio");    
...
fputs($ar,'001');
//fputs($ar,",");
fputs($ar,'000000'.$row['relacionado']);
//fputs($ar,",");
fputs($ar,"0000".$c1);
//fputs($ar,",");
fputs($ar,$nit);

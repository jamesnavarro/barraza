...
?>
<script type="text/javascript" language="javascript" src="../vistas/atenciones/funciones.js?v=1.3"></script>
<script>
                                    ...
                                    <div class="row-fluid">
                                                ...
                                                <td><label>Estado de la orden:</label></td>
                                                           <td><select id="estado" style="width:130px">
                                                                  <?php if($_SESSION["area"]=='OFICINA'){ ?> <option value="">..Todas...</option><?php } ?>
                                                                   ...
                                                                   <?php if($_SESSION["area"]=='OFICINA'){ ?><option value="99">Completada</option><?php } ?>
                                                               </select></td>
                                                </tr>
                                            ...
                                            <tr>
                                                <td><input type="button" onclick="MostrarAtenciones(1);" value="Buscar" class="btn-primary">
                                                    <input type="reset" value="Limpiar" onclick="limpiar_atenciones();"  class="btn-danger"><span  id="cargar"></span></td><td>
                                                    
                                               
                                                <select  class="sp1"  name="municipio" id="mun" style="width:120px;"> 
                      <?php   
                          echo '<option value="">Seleccione el Municipio...</option>';
                          $consulta2= "SELECT * FROM `departamentos` where cod_dep='08'  ";                     
                               ...
                               echo '<option value="'.$valor1.'">'.$fi['nombre_mun'].'</option>';
                                }
                       ?>  
                            </select>
                                            ...
                                            <tr>
                                                <td>Posibles COVID</td>
                                                 <td><select id="bcov" style="width: 70px" title="Buscar por posibles covid" data-toggle="tooltip">
                                                           <option value="">Todos</option>
                                                           <option value="Si">Si</option>
                                                           <option value="No">No</option>
                                         
                                                       </select></td>
                                                  <td>Pruebas tomadas COVID</td>
                                                   <td><select id="btom" style="width: 70px" title="Pruebas Tomadas" data-toggle="tooltip">
                                                           <option value="">Todos</option>
                                                           <option value="Si">Si</option>
                                                           <option value="No">No</option>
                                         
                                                       </select>
                                                       <select id="bres" style="width: 100px" title="Buscar por resultados" data-toggle="tooltip">
                                        ...
                                        <div class="span12 widget lime">
                                            ...
                                            <section class="body">
                                                <div class="body-inner no-padding">
                                                       <p id="msg"></p><select id="filas" style="width: 60px" title="Mostrar Filas de:" data-toggle="tooltip">

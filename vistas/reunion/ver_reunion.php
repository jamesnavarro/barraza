 ...
 ?>
                    <div class="row-fluid">
                        <div class="span12 widget dark stacked">
                            <header>
                                <h4 class="title">Detalle de Reuniones</h4>
                            </header>
                            <section class="body">
                                    ...
                                    <div class="row-fluid">
                                        ...
                                        <div class="span3">
                                            <ul class="arrow">
                                                ...
                                                <b>Detalle </b>:<?php  echo $descripcion_lla;  ?></li>
                                            <?php  if($_SESSION['k_username']==$asignado_lla || $_SESSION['admin']=='Si'){     ?>
                                                <a href="../vistas/?id=reunion&cod=<?php  echo $_GET["cod"];  ?>"><img src="../imagenes/modificar.png"></a>
                                                <a href="../vistas/?id=reuniones&del=<?php  echo $_GET["cod"];  ?>"><img src="../imagenes/eliminar.png"></a>
                                            <?php }   ?>
                                            </ul>
                                        </div>
                                        <div class="span3">
  ...
  <?php
 if(isset($_GET['cod'])){
require '../vistas/reunion/detalles.php';
 }
 ?>
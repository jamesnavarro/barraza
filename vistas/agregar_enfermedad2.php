...
<html>
	...
	<script type="text/javascript" src="../js/jquery.equalHeight.js"></script>
	 ...
	 $('#tabla').dataTable();
        ...
        function pasar_enfermedad2(){
        window.opener.enfermedad_add2(document.getElementById('datos1').value, document.getElementById('datos2').value);
        window.close();
        }
        </script>
        <style>
...
.CSSTableGenerator tr:first-child td:last-child{
    ...
    <body  onload="javascript:pasar_enfermedad2();">
                ...
                <table class="table table-bordered table-striped table-hover" id="">
                    <tr>
                        <td>
                            <?php
                            if($page>1){?>
                            <a href="../vistas/agregar_enfermedad2.php?page=1"><img src="../images/a1.png"></a>
                            <a href="../vistas/agregar_enfermedad2.php?page=<?php echo $page - 1;?>"><img src="../images/a11.png"></a>
                            <?php
                            }else{
                            ...
                            <?php
                            if($page<$last_page){?>
                            <a href="../vistas/agregar_enfermedad2.php?page=<?php echo $page + 1;?>"><img src="../images/p1.png"></a>
                            <a href="../vistas/agregar_enfermedad2.php?page=<?php echo $last_page;?>"><img src="../images/p11.png"></a>
                            <?php
                            }else{
                            ...
                            while($row=mysql_fetch_array($request))
                            {     
                            $ver='<a href="../vistas/agregar_enfermedad2.php?cod='.$row["codigo_enf"].'">';

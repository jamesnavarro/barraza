...
$hora = date('h:i a',time() - 3600*date('I'));
        ...
        $sql = "INSERT INTO `precios_alquiler` (`id_alquiler`, `id_empresa`, `precio_alquiler`, `fecha_registro_a`)";
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_alquiler.php?cod=<?php echo $_GET['cod'] ?>&add" method="post" enctype="multipart/form-data">

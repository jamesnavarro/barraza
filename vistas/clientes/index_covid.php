...
<script src="funciones_cov.js?v=1.7"></script>
<script src="../../js/bootstrap.min.js"></script>
    </head>
    <body onload="Llenar_pac('<?php echo $_GET['id'] ?>');pagina(1,'<?php echo $_GET['emp'] ?>');">
        <div>
            <h3>Registro de Pacientes Covid</h3>
        </div>
        <div   class="border"> 
    ...
    <div id="menu3" class="tab-pane fade">
      ...
      <table>
            <tr>
                        ...
                        <td><input type="text" class="sp3" id="enf"  placeholder="" value="B342"/><img src="../../images/buscar.png" onclick="enfermedad();"></td>
                    	<td>Descripcion de enfermedad: </td>
                        <td><input type="text" class="sp1" id="obs" data-toggle="tooltip" value="INFECCION DEBIDA A CORONAVIRUS, SIN OTRA ESPECIFICACION" title="Descripcion de la enferemedad"/></td>
                    </tr>
                     <tr>

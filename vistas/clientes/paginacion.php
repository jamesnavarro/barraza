...
$request=mysql_query('SELECT count(*) FROM pacientes where id_empresa="'.$_GET['emp'].'" ');
            if($request){
...
$limit = 'LIMIT ' .($page - 1) * $rows_by_page .',' .$rows_by_page;
 $sql = mysql_query("SELECT * FROM pacientes where id_empresa='".$_GET['emp']."' order by id_paciente asc ".$limit);

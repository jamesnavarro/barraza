...
//////////
 ...
 ?>
                ...
                <form name="insertar_empresa"  class="span12 widget shadowed dark form-horizontal bordered"  action="../modelo/editar_pago.php?editar=<?php echo $_GET['fact']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <header><h4 class="title">Recibo de Caja # : <?php echo $num_fact ?></h3>
                                <?php 
    if($editar_fac=='Habilitado'){ 
        ?>
                            <a href="../vistas/?id=facturacion_ventas&fact=<?php echo $orden_int ?>&factura=<?php echo $_GET['fact'] ?>"><img src="../imagenes/estrella.png">
    <?php }     ?>
                                </h4>
				...
				<div class="module_content"> 
                           <br>
                                        <hr>
                                          ...
                                          <a target="_blank" href="../imprimir_recibo_ven.php?imprimir=<?php echo $num_fact ?>"><input type="button" name="bo" value="Imprimir"/> </a>
...
$table = $table.'</thead>';
	...
	{       
                ...
                $t2=$t2+$st2;
		$table = $table.'<tr><td>'.$row["cod_equipo"].'</td><td>'.$row['nombre'].'</td><td>'.$row['anexo'].'</td><td>'.$row['cantidad'].
                        '</td>
                             <td>'.$row['meses'].'</td>
                                <td>'.$row['fecha_a'].'</td>

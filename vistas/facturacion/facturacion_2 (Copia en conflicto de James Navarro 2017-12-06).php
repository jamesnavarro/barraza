...
//////////
 ...
 ?>
    ...
    if($editar_fac=='Habilitado'){ 
        ?>
                        <a href="../vistas/?id=facturacion_alquiler&fact=<?php echo $orden_int ?>&factura=<?php echo $_GET['fact'] ?>"><img src="../imagenes/estrella.png"></a>
    <?php }  ?>
				...
				<div class="module_content"> 
                           <br>
                                        <hr>
                                          ...
                                          <a target="_blank" href="../imprimir_alquiler.php?imprimir=<?php echo $num_fact ?>"><input type="button" name="bo" value="Imprimir"/> </a> 
                                          <a href="../vistas/?id=facturacion_2&fact=<?php echo ($_GET['fact'] - 1 ) ?>"> << </a> Paginacion 
                                          <a href="../vistas/?id=facturacion_2&fact=<?php echo ($_GET['fact'] + 1 ) ?>"> >> </a>
                                        <hr><br>
                                       <hr><br>
...
$request2=mysql_query('select a.*, b.* from equipos_asig a, alquiler b where a.cod_equipo=b.codigo and a.facturado="'.$_GET['fact'].'"');
...
//    echo'<hr>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["cod_equipo"].'</td>'
                                ...
                                <td>'.$row['fecha_a'].'</td>
                                <td>'.$row['fecha_f'].'</td>'
                                . '<td>'.number_format($row['precio_a']).'</td>'
                                . '<td>'.number_format($row['precio_a']*$row['cantidad']*$row['meses']).'</td></tr>';

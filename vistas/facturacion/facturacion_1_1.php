...
<?php 
     if(isset($_GET['fact'])){              
$request=Connection::runQuery('select *, max(cant_ins) as c from actividad where estado="Completada" and orden_servicio="'.$_GET['fact'].'"  group by cod_aten');
...
$table = $table.'</thead>';
	...
	{       
                ...
                $t1=$t1+$st1;
		$table = $table.'<tr><td>'.$row["cod_aten"].'</td><td>'.$row['Description'].'</td><td>'.$row['anexo'].'</td><td>'.$row['c'].
	...
	{       
                ...
                $t2=$t2+$st2;
		$table = $table.'<tr><td>'.$row["cod_equipo"].'</td><td>'.$row['nombre'].'</td><td>'.$row["inf"].'</td><td>'.$row['cantidad'].
	...
	{       
               $st3=$row['sub_precio']*$row['cant_usada'];
                $t3=$t3+$st3;
		$table = $table.'<tr><td>'.$row["cod_insumo"].'</td><td>'.$row['nombre_insumo'].'</td><td>'.$row["inf_adicional"].'</td><td>'.$row['cant_usada'].
	...
	{       
               $st4=$row['sub_precio_m']*$row['cantidad_usada'];
                $t4=$t4+$st4;
		$table = $table.'<tr><td>'.$row["cod_med"].'</td><td>'.$row['nombre_medicamento'].'</td><td>'.$row["info"].'</td><td>'.$row['cantidad_usada'].
	...
	{       
               $st5=$row['precio_lab']*$row['cantidad'];
                $t5=$t5+$st5;
		$table = $table.'<tr><td>'.$row["cod_lab"].'</td><td>'.$row['nombre_lab'].'</td><td>'.$row["inf"].'</td><td>'.$row['cantidad'].
	...
	{       
               $st5=$row['precio_v']*$row['cantidad'];
                $t5=$t5+$st5;
		$table = $table.'<tr><td>'.$row["codigo_interno"].'</td><td>'.$row['nombre'].'</td><td>'.$row["info"].'</td><td>'.$row['cantidad'].

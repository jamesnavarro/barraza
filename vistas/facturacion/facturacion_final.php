 ...
 ?>
		...
		<div class="clear"></div>
                <article class="module width_full">
                    <header><h3 align="center">generar FACTURA</h3></header>
...
$table = $table.'</thead>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["orden_servicio"].'</td><td>'.$row["orden_externa"].'</td><td>'.$row["cod_aten"].'</td><td>'.$row['Description'].'</td><td>'.$row['anexo'].'</td><td>'.$row['c'].
                        '</td><td>'.$row['precio_total'].'</td><td>'.$row['precio_total']*$row['c'].'</td>
                            <td><a href="../form_editar/precios.php?atencion='.$row["Id"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["rel_atencion"].'</td><td>'.$row["autorizacion"].'</td><td>'.$row["cod_equipo"].'</td><td>'.$row['nombre'].'</td><td>'.$row["inf"].'</td><td>'.$row['cantidad'].
                        '</td><td>'.$row['precio_a'].'</td><td>'.$row['precio_a']*$row['cantidad'].'</td><td><a href="../form_editar/precios.php?equipo='.$row["id_equipo_a"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["rel_atencion"].'</td><td>'.$row["autorizacion"].'</td><td>'.$row["cod_insumo"].'</td><td>'.$row['nombre_insumo'].'</td><td>'.$row["inf_adicional"].'</td><td>'.$row['cant_usada'].
                        '</td><td>'.$row['sub_precio'].'</td><td>'.$row['sub_precio']*$row['cant_usada'].'</td><td><a href="../form_editar/precios.php?insumo='.$row["id_ia"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["rel_atencion"].'</td><td>'.$row["autorizacion"].'</td><td>'.$row["cod_med"].'</td><td>'.$row['nombre_medicamento'].'</td><td>'.$row["info"].'</td><td>'.$row['cantidad_usada'].
                        '</td><td>'.$row['sub_precio_m'].'</td><td>'.$row['sub_precio_m']*$row['cantidad_usada'].'</td><td><a href="../form_editar/precios.php?medicina='.$row["id"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
	...
	{       
		...
		$table = $table.'<tr><td>'.$row["rel_atencion"].'</td><td>'.$row["autorizacion"].'</td><td>'.$row["cod_lab"].'</td><td>'.$row['nombre_lab'].'</td><td>'.$row["inf"].'</td><td>'.$row['cantidad'].
                        '</td><td>'.$row['precio_lab'].'</td><td>'.$row['precio_lab']*$row['cantidad'].'</td><td><a href="../form_editar/precios.php?laboratorio='.$row["id_lab_a"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
	...
	{       
               $st6=$row['precio']*$row['cantidad'];
                $t6=$t6+$st6;
		$table = $table.'<tr><td>'.$row["rel_atencion"].'</td><td>'.$row["autorizacion"].'</td><td>'.$row["cod_pro"].'</td><td>'.$row['nombre'].'</td><td>'.$row["info"].'</td><td>'.$row['cantidad'].
                        '</td><td>'.$row['precio'].'</td><td>'.$row['precio']*$row['cantidad'].'</td><td><a href="../form_editar/precios.php?venta='.$row["id_venta"].'"><img src="../imagenes/modificar.png" alt="ver" height="20px" width="20px"></a></td></tr>';
...
<tr>
    ...
    <td>$ <input type="text" readonly name="total" value="<?php echo $total; ?>"></td>
                ...
                <form name="insertar_empresa" action="../modelo/insertar_factura.php" method="post" enctype="multipart/form-data">
		<article class="module width_full">
...
<!--                                       <fieldset style="width:100%; float:center; margin-right: 3%;">
                                       ...
                                       <table> <tr>
                                                                   ...
                                                                   <option value="12">12</option>
                                                                    ...
                                                                    <td><label></label></td>
                                                                    <td><input type="checkbox" name="pendiente" value="No"></td>

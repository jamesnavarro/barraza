...
if(isset($_GET['fact'])){
$consulta2= "SELECT * FROM facturas a, sis_empresa b WHERE a.id_empresa=b.rips AND a.numero_factura='".$_GET['fact']."' AND tipo='FAC'";
$result2=  mysql_query($consulta2);
...
$nombre_paciente='Factura por bloque alquiler';
$cedula_paciente='';
$diagnostico='Alquileres';
$enfermedad='Alquiler de equipos';
				...
				<div class="module_content"> 
                           <br>
                                        <hr>
                                           ...
                                           <a target="_blank" href="../imprimir_alquiler_agrupado.php?imprimir=<?php echo $num_fact ?>&estado=<?php echo $estado ?>"><input type="button" name="bo" value="Imprimir Agrupado"/> </a>  
                                           <a target="_blank" href="../imprimir_alquiler_det.php?imprimir=<?php echo $num_fact ?>&estado=<?php echo $estado ?>"><input type="button" name="bo" value="Imprimir Detallado"/> </a>                                 
                                        <hr><br>
                                       <hr><br>

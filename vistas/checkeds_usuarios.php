...
<head>
    ...
    <title>Selecciones Usuarios </title>
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_usuarios.php?add" method="post" enctype="multipart/form-data">
...
$request=mysql_query("SELECT * FROM `usuarios` where estado_empleado='Activo' ");
}
...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="tabla">';
             ...
             $table = $table.'<th  width="10%">'.'Codigo'.'</th>';           
              $table = $table.'<th width="40%">'.'Nombre del Profesional'.'</th>';   
	...
	{       
                ...
                <td  width="10%">'.$row["id"].'</td>'
                          ...
                          . '<td width="10%">'.$row['usuario'].'</a></td>'
                          . '<td  width="10%">'.$row["cargo"].'</td>
               <td width="10%"><input type="checkbox" value="'.$row["id"].'" name="id'.$cont.'"></td>
                   </tr>';   
    ...
    if(isset($_POST["cant"]))
    {
        ...
        for($x=1; $x<=$n; $x=$x+1){
            if(isset($_POST["id$x"])){
                ...
                $sql = "INSERT INTO `correos_para` (`id_user`,`id_de`)";
            $sql.= "VALUES ('".$_POST["id$x"]."','".$_SESSION["id_user"]."')";

...
<html>
    ...
    <body onLoad="cerrar()">
<form name="insertar" action="../modelo/insertar_equipo_asig.php" method="post" enctype="multipart/form-data">
             ...
             <input type="submit" name="enviar" value="Guardar">
                ...
                <table>                                <tr>
                                                           ...
                                                           <td><input type="text" name="orden" style="width:130px;height:20px;" value="<?php echo $orden_interna ?>"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>codigo Equipo : <font color="red"> *</font></label></td>
                                                            <td>
                                                                <input type="text" name="insumo2" id="valor2" style="width:130px;height:20px;"/>
                                                                <a href='javascript: alquiler()'><input type="button" name="cancelar" value="Seleccionar"></a></td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>precio : <font color="red"> *</font></label></td>
                                                            <td><input type="text" name="precio" id="valor3" style="width:130px;height:20px;"/>
                                                                </td>
                                                        </tr>
                                                        <tr>
                                                            <td><label>descripcion:</label></td>
                                                            <td><input type="text" name="nombre_med" id="valor1" style="width:280px;height:20px;"/>
                                                                </td>
                                                        </tr>
                                                          <tr>
							<tr>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td><textarea style="width:90%;" rows="3" name="descripcion"></textarea></td>
                                                          </tr>     
                                                     </table>
                                        <input type="submit" name="enviar" value="Guardar">
					<a href="../vistas/detalle_ordenes.php?codigo=<?php echo $orden_interna ?>"><INPUT TYPE="button" VALUE="Cancelar"></a>

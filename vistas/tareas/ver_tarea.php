 ...
 ?>
                    <div class="row-fluid">
                        <div class="span12 widget dark stacked">
                            <header>
                                <h4 class="title">Detalle de Tareas</h4>
                            </header>
                            <section class="body">
                                    ...
                                    <div class="row-fluid">
                                        <div class="span3">
                                            <ul class="arrow">
                                                ...
                                                <li><b>Fecha Inicial :</b><?php  echo $fecha_inicio_lla;  ?></li>
                                                <li><b>Fecha Final:</b><?php  echo $fecha_vencimiento_lla;  ?></li>
                                        ...
                                        <div class="span3">
                                            <ul class="arrow">
                                                ...
                                                <li><b> Relacionado con:</b><?php  echo $relacion_lla;  ?></li>
                                                <b>Id Relacion : </b><?php  echo $ver;  ?>
                                        ...
                                        <div class="span3">
                                            <ul class="arrow">
                                                ...
                                                <li><b>Modificado por :</b><?php  echo $mod_user;  ?></li>
                                                 ...
                                                 $sql1 = "SELECT * FROM sis_contacto where id_contacto=".$id_contacto_lla."";
                                                $fila1 =mysql_fetch_array(mysql_query($sql1));
                                                $id_cliente = $fila1["id_contacto"];$nombre_cli = $fila1["nombre_cont"];
                                                 echo '<a href="../vistas/?id=clientes&cod='.$id_cliente.'">'.$nombre_cli.'</a>';   ?></li>
                                                 <?php  if($_SESSION['k_username']==$asignado_lla || $_SESSION['admin']=='Si'){     ?>
                                                <a href="../vistas/?id=tarea&cod=<?php  echo $_GET["cod"];  ?>"><img src="../imagenes/modificar.png"></a>
                                                <a href="../vistas/?id=tatreas&del=<?php  echo $_GET["cod"];  ?>"><img src="../imagenes/eliminar.png"></a>
                                                 <?php } ?>
                                            </ul>
                                        </div>
                                        <div class="span3">
                                            <img src="../imagenes/tareas.png">
                                        </div>
...
<?php
 if(isset($_GET['cod'])){
require '../vistas/tareas/detalles.php';
 }
 ?>
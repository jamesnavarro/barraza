...
$hora = date('h:i a',time() - 3600*date('I'));
         $fecha = date("Y-m-d").' '.$hora;
                ...
                $sql = "INSERT INTO `precios_ventas` (`id_venta`, `id_empresa`, `precio_v`, `fecha_registro_pr`)";
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_ventas.php?cod=<?php echo $_GET['cod'] ?>&add" method="post" enctype="multipart/form-data">
     <button type="submit"><img src="../imagenes/add.png"> Agregar</button> 
<?php

$request=mysql_query("SELECT * FROM `productos` ");
...
//    echo'<hr>';
	...
	{       
                ...
                <td  width="10%">'.$row["codigo"].'</td>'
                          . '<td width="40%">'.$row['nombre'].'</a></td><td width="10%">'.number_format($row['precio']).'</a></td>

...
$hora = date('h:i a',time() - 3600*date('I'));
         $fecha = date("Y-m-d").' '.$hora;
                ...
                $sql = "INSERT INTO `precios_insumos` (`id_insumo`, `id_empresa`, `precio`, `fecha_registro_pr`)";
                        ...
                        <div class="span12 widget lime">
                            ...
                            <section class="body">
                                ...
                                <div class="body-inner no-padding">
                                    ...
                                    <form name="buscarA" action="../vistas/checkeds_insumos.php?cod=<?php echo $_GET['cod'] ?>&add" method="post" enctype="multipart/form-data">
...
$request=mysql_query("SELECT * FROM `insumos` ");
}
...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="tabla">';
             ...
             $table = $table.'<th  width="10%">'.'Codigo'.'</th>';           
              ...
              $table = $table.'<th width="20%">'.'Precio Base'.'</th>'; 
	...
	{       
                ...
                <td  width="10%">'.$row["codigo"].'</td>'
                          . '<td width="40%">'.$row['nombre_insumo'].'</a></td><td width="20%">'.number_format($row['precio_ins']).'</a></td>

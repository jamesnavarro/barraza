<?php 
$request=mysql_query('select count(*) from sis_proyecto_tarea');
if($request){
                      ...
                      <!-- START Widget Collapse -->
                        ...
                        <div class="span12 widget dark stacked">
                            ...
                            <header>
                                ...
                                <h4 class="title">Lista de Tareas de Proyectos</h4>
...
<?php
if($page>1){?>
	<a href="../vistas/?id=tareas_proyectos&page=1"><img src="../images/a1.png"></a>
	<a href="../vistas/?id=tareas_proyectos&page=<?php echo $page - 1;?>"><img src="../images/a11.png"></a>
<?php
}else{
...
<?php
if($page<$last_page){?>
	<a href="../vistas/?id=tareas_proyectos&page=<?php echo $page + 1;?>"><img src="../images/p1.png"></a>
	<a href="../vistas/?id=tareas_proyectos&page=<?php echo $last_page;?>"><img src="../images/p11.png"></a>
<?php
}else{
...
$request=mysql_query("SELECT * FROM sis_proyecto_tarea a, sis_proyecto b where a.id_proyecto=b.id_proyecto ".$limit);
  }
...
//    echo'<hr>';
       $table = '<table class="table table-bordered table-striped table-hover" id="">';
             ...
             $table = $table.'<thead >';
              ...
              $table = $table.'<th width="20%">'.'Tarea del Proyecto'.'</th>'; 
	...
	{      
            ...
            $table = $table.'<tr><td width="20%"><a href="../vistas/?id=tarea_proyecto&cod='.$row['id_tp'].'">'.$row['nombre_tarea'].'</a></td>
                <td width="20%"><a href="../vistas/?id=ver_proyectos&cod='.$row['id_proyecto'].'">'.$row['nombre_pro'].'</a></td>
...
<?php
 if(isset($_GET['del'])){
$sql = "DELETE FROM sis_proyecto WHERE id_proyecto=".$_GET['del']."";

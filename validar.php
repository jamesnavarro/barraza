			...
			$_SESSION["k_username"] = $row['usuario'];
			 ...
			 $_SESSION["nombre"] = $row['nombre'].' '.$row['apellido'];
			             ...
			             if($_SESSION["area"]=='OFICINA'){
                               if($re['count(*)']==0){
                                    header("location:vistas/?id=ordenes_all");
                               }else{
                                 echo '<script lanquage="javascript">alert("Usted Tiene '.$re['count(*)'].' Mensajes Nuevos");location.href="vistas/?id=ordenes_all"</script>';
                               }
                           }ELSE{
